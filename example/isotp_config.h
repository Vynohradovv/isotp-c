 ...
 *
 *  [ 0x00 – 0x7F ] 0ms - 127 ms; [ 0xF1 - 0xF9 ] 100ms - 900ms
 */
#define ISO_TP_DEFAULT_ST_MIN_MS            ( 0 ) 
 ...
 */
#define ISO_TP_FRAME_PADDING                 ( 0 )

/* Private. Size internal buffer for debud logger
*/
#define ISP_TP_BUFFER_DEBUG_SIZE             ( 128 )
